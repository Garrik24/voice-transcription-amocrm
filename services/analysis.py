...
- Дублировать информацию из полей cost, work_type, next_steps, payment_terms
...
{{{{
  "client_name": "Давид",
  "manager_name": "Игорь",
  "summary": "Клиент Давид — вынос границ участка (~80 соток, ровная форма), район Старомарьского шоссе, рядом с автосалоном Хрополь / «Четыре сезона». GPS в этом районе глушится — возможен геодезический ход вместо стандартного выноса. Порекомендовал обратиться Алексей из компании. Договорились: Давид скинет кадастровый номер в Telegram, после чего будет определена точная цена и дата выезда.",
